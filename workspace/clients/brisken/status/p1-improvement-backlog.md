...
### 123. Nobody is told when the app is down; the last outage was surfaced by the owner, not by a monitor (2026-09-17 audit draft #121, unranked; operations) (SHIPPED 2026-09-18, PR #1098; alert path fixed PR #1106; CRON HAS NEVER FIRED as of 2026-09-18 16:25Z, hand dispatch only, three options await the owner; see Shipped rows below)
