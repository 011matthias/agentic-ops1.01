...
### 134. A right category guess could never leave "needs a look" (note #62, Criss, 2026-09-17) (SHIPPED PR #988, Fly v150; SPA prompt pending)
...
### 135. The card could not be changed on a row whose receipt printed one, and a pick never reached the matcher (note #63, Criss, 2026-09-17) (SHIPPED PR #988, Fly v150; SPA prompt pending)
