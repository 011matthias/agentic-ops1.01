...
### 157. The tool's own verdict was the one `decisions` writer no test reached (traceability follow-up; owner 2026-09-18) (SHIPPED 2026-09-20, PR #PENDING; Shipped row 104)
...
Pinned in `tests/test_tool_decision_statement_id_157.py` (3, route-level): the
...
### 158. "Add more receipts" opens the receipt view in a new tab and adds nothing (feedback note #70, operator matthias 2026-09-18)
