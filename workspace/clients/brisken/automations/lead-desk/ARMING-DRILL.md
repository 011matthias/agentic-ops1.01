...
| 2026-08-13 | 3 (real self-send) | PASS | `lead-desk-drill step3` on prod, sent 19:26:08Z as matthias -> matthias; sent_items_readback_found_imid PASS (imid `<SJ0PR22MB280982CAF7572A598223EFFF8FDB2@SJ0PR22MB2809.namprd22.prod.outlook.com>`); inbox landing verified by read-only Graph probe: received 19:26:12Z, same imid. Steps run 1 -> 3 -> 4 -> 2: the drill campaign (prereq for step 2) needs the external test address, which is chosen at step-5 prep |
| 2026-08-13 | 4 (NDR -> bounce -> auto-suppress) | PASS | `step4 --to drill-nobody-20260813@gmail.com` sent 19:26:47Z; Exchange NDR landed 19:26:54Z with GERMAN subject `Unzustellbar: ...` (classifier fine: `_NDR_SUBJECT_RE` covers unzustellbar, and the MicrosoftExchange sender matches `_NDR_SENDERS`); ingested by the ~19:35 capture tick, within 1 tick of send. `step4-verify` PASS: bounce_event_recorded (bounce ts 19:26:54Z) + auto_suppressed_reason_bounced. Contact `drill-ndr-d9ff6da4bb` remains the suppressed namespaced fixture |
