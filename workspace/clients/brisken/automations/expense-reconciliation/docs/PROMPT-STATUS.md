...
|---|---|---|
| `lovable-memory-at-signoff-prompt.md` (item 88) | `toast.publishedSaved`, `toast.publishedMemoryFailed` | Backend PR #940 live on Fly; the toast has no live case until a month is published |
