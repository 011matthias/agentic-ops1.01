...
# page edges and its outer columns are cut off, while the text layer still
# reads the clipped cells, which is how the 732 pt listing shipped from item
# 24 (2026-08-23) to item 143. `tests/test_pdf_tables_fit_the_page.py`
