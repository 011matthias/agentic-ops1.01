...
`workspace/clients/brisken/deliverables/brisken-treasurycentral-restyle-blueprint.md`
...
1. The file to edit: `deliverables/brisken-onepilot-website-prototype.html`
   (single-file HTML, self-contained, polished).
2. Naming + positioning truth:
   `context/lead-generation/brisken-product-catalog.md`, the "Spine
...
3. The evergreen site blueprint:
   `deliverables/brisken-onepilot-website-blueprint.md` (positioning,
...
4. The marketing spine it serves:
   `deliverables/lead-gen-strategy-2026-06-12.html`, Marketing tab
...
1. `uv run tools/validate-html.py workspace/clients/brisken/deliverables/brisken-onepilot-website-prototype.html`
