...
const PROSPECTS = {
  ...
  zalando: {
    ...
    problemHead: [{text:"Treasury is expected to deliver on SAP, fast.\n",options:{}},
                  {text:"The data behind it lives in a dozen places.",options:{color:C.cyan}}],
    proofExtra: "Your S/4HANA migration is the moment these feeds get decided; TreasuryCentral is decided once and moves with you.",
...
// Task-scoped output (leadgen/task-3). Reads shared assets from .scratch read-only;
// writes only inside output/leadgen-task-3/.
const OUTDIR = "C:/Users/neuma_p1qrsic/Repo/agentic-ops1-leadgen-task-3/output/leadgen-task-3/collateral-pack";
const OUT = OUTDIR + "/" + cfg.stem + ".pptx";
