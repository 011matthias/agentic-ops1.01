...
from sqlalchemy import create_engine, Column, String, DateTime, JSON, Integer, Text, Boolean, text
...
def init_db():
    ...
    # Idempotent column migrations (for existing deployed DBs without Alembic)
    with engine.connect() as conn:
        for stmt in [
            "ALTER TABLE pending_orders ADD COLUMN invoice_interval INTEGER",
        ]:
            try:
