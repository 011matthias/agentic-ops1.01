# Cover Letter -- AI Automation Agency Partner

## Upwork Plain Text (copy-paste ready)

Hi there,

https://unpauseai.com/clients/ai-automation-agency-partner/
(Access code: ai-partner-2026)
...
- Three engagement models (hourly, project-based, retainer)
...
- Python and JavaScript (backend, code nodes, API integrations)
- OpenAI and Claude APIs (classification, generation, structured output)
- Google Sheets, MySQL, REST/webhook integrations

Rate: $35.63/hr on Upwork. I also scope project-based work when the deliverables are clear, and offer retainer arrangements for ongoing support. Happy to discuss what works best for your setup.

Availability: I can start within the week and I'm available 20-30 hrs/week for the next 4 weeks. Flexible on scheduling.
