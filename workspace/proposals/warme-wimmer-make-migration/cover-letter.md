    ...
    I also noticed you've built a custom ERP (OSNeo) and have a strong technical team in place. That tells me the Make.com scenarios are probably more than simple triggers -- they're likely wired into your internal systems in ways that aren't obvious from the outside. That's exactly why the audit-first approach matters here.
