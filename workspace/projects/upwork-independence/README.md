...
acquisition. The STRATEGY layer is settled by six optimize runs
...
| `acquisition-portfolio.json` | Optimize asset — channel effort mix (LinkedIn 0.3683, demo-first 0.2992, AEO 0.1778, referral 0.1547, cold-email 0.0 retired). |
...
- The operative acquisition plan is the portfolio-no-cold mix (cold email
  retired by owner order 2026-09-05, pinned to 0.0). The gtm-v2-confirm
...
- The UWG §7 fence (no DE cold email) stays structural in the optimize guards
  and still governs any client-side sending work we deliver.
