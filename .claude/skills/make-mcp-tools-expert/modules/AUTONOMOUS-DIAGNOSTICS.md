...
> Make.com implementation of observable state diagnostics. See `.claude/rules/behaviors.md` for outcome verification principles.
...
5. **Check execution detail:** `executions_get_detail(scenarioId, executionId)` — limited data available but always try
