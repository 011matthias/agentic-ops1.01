...
Unified reference for building n8n workflows. Consolidates: n8n-mcp-tools-expert, n8n-workflow-patterns, n8n-node-configuration, n8n-expression-syntax, n8n-validation-expert, n8n-code-javascript, n8n-code-python, n8n-converter.
...
| Converting from Make.com | [n8n-converter SKILL](../n8n-converter/SKILL.md) + [modules](../n8n-converter/modules/) | n8n-converter |
