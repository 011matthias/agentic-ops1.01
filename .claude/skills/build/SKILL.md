...
### Invoke Testing Checklist

After code is written, invoke the `testing-checklist` skill to generate a step-by-step guide for verifying the automation works end-to-end.
