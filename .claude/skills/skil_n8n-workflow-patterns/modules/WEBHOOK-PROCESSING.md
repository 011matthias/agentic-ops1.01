...
**Related**:
- [n8n Expression Syntax](../../skil_n8n-expression-syntax/SKILL.md) - Accessing webhook data correctly
- [HTTP-API-INTEGRATION.md](HTTP-API-INTEGRATION.md) - Making HTTP requests in response
