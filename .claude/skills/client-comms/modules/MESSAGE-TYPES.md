...
**Structure:**
1. Quick summary of what was discussed (2-3 key points)
2. Decisions made (explicitly stated)
3. Action items with owners (who does what)
4. Next steps / timeline

**Context to load:** Latest checkpoint, process-notes

**Tone:** Clear, organized. This is a reference document they'll come back to.
...
- On Upwork: no bullet points. Use short numbered paragraphs or flowing text.
