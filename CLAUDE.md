...
- **Rules** (17) — Always-on constraints in `.claude/rules/` (behaviors, session start, session pressure, plus the hard-constraint standards). Orchestrator detection deferred to build-time.
